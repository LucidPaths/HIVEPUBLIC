"""
Shared utilities for CLAUDE_STATE.md auto-maintenance.
...
def parse_curated_sections(state_content):
    """Extract curated (accumulating) sections from CLAUDE_STATE.md."""
    sections = {}
...
def auto_update_state(transcript_path, trigger_reason="session activity"):
    ...
    for header in CURATED_SECTIONS:
        if header in curated:
            ...
            # Skip empty sections — don't pollute state file with placeholders
            pass
